...
namespace Caretta.Data.Migrations
{
    ...
    [Migration("20240805121332_enum-description")]
    partial class enumdescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caretta.Core.Entity.UserFavouriteCategories", b =>
                {
            ...
            modelBuilder.Entity("Caretta.Core.Entity.UserLikeComments", b =>
                {
            ...
            modelBuilder.Entity("Caretta.Core.Entity.UserLikeContents", b =>
                {
                    b.Property<Guid>("ContentId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("CONTENT_ID");
            ...
            modelBuilder.Entity("Caretta.Core.Entity.UserFavouriteCategories", b =>
                {
                    b.HasOne("Caretta.Core.Entity.Category", "Category")
                        .WithMany("UserFavouriteCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Caretta.Core.Entity.UserLikeComments", b =>
                {
                    b.HasOne("Caretta.Core.Entity.Comment", "Comment")
            ...
            modelBuilder.Entity("Caretta.Core.Entity.Category", b =>
                {
                    ...
                    b.Navigation("UserFavouriteCategories");
                });
